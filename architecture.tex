...
\begin{figure*}
\includegraphics[scale=0.80]{img/runtimeView_qdm.png}
...
We implemented our DSL using Xtext~\cite{eysholdt2010}, which generates plugins that allow editing code in both Eclipse and IntelliJ. 
...
from or DSL. This effort involves a custom Maven plugin that currently generates simple test cases, 
...
\begin{figure}[!ht] \centering
  \includegraphics[width=.42\textwidth]
  {img/plugin.jpg}
...
and a cucumber feature (Figure \ref{fig:cucumber}) that exercises the \shc and compares the expected results declared in the feature. 
